  ...
  return (
    <section id="contact" className="py-20 md:py-28 bg-forest text-cream relative overflow-hidden border-t-2 border-forest-dark">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8">
        ...
        <h2 className="font-display text-3xl sm:text-4xl md:text-6xl text-cream font-normal tracking-tight max-w-4xl mx-auto leading-[1.12]">
          Let's write the version of your story{' '}
          <span className="italic font-light text-mint">the internet remembers.</span>
        </h2>

        <p className="text-sm sm:text-base text-cream/80 max-w-xl mx-auto font-normal">
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 bg-mint text-forest text-xs sm:text-sm font-bold uppercase tracking-wider hover:bg-cream transition-all shadow-lg active:translate-y-0.5"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-4 bg-forest-surface hover:bg-forest-dark text-cream text-xs sm:text-sm font-medium tracking-wide border border-sage/40 transition-colors"
          >
            {copied ? (
              <>
        ...
        {/* Direct Channels Bar */}
        <div className="pt-10 border-t border-sage/25 flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-xs sm:text-sm text-cream/80">
          <a
            href={`mailto:${brand.email}`}
            className="inline-flex items-center gap-1.5 hover:text-mint transition-colors font-mono"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 hover:text-mint transition-colors font-mono underline underline-offset-4"
          >
