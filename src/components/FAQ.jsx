...
export const FAQ = ({ onOpenBooking }) => {
  ...
  return (
    <section id="faq" className="py-16 md:py-24 bg-cream border-b border-charcoal-border/80">
            ...
            return (
              <div
                ...
                className={`border transition-colors ${
                  isOpen
                    ? 'bg-white border-forest/50 shadow-xs'
                    : 'bg-white/70 border-charcoal-border hover:border-charcoal-border/80'
                }`}
              >
                <button
                ...
                >
                  <span className="font-sans font-bold text-base sm:text-lg text-charcoal tracking-tight">
                    {item.question}
                  </span>
                  <div
                    className={`w-7 h-7 flex items-center justify-center flex-shrink-0 transition-colors ${
                      isOpen ? 'bg-forest text-cream' : 'bg-mint/50 text-forest'
                    }`}
                  >
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <div className="px-6 sm:px-7 pb-6 text-sm text-charcoal/85 leading-relaxed border-t border-charcoal-border/40 pt-4 font-normal">
                        {item.answer}
                      </div>
                    </motion.div>
                  )}
        ...
        <div className="mt-12 text-center">
          <p className="text-xs sm:text-sm text-charcoal-muted">
            ...
            <button
              ...
              className="text-forest font-bold underline underline-offset-4 hover:text-forest-dark"
            >
