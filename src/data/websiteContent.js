...
Resonance first. Reach follows.`,
  ...
  whyPersonalBranding: {
    ...
    subheading: "The right opportunities start finding you.",
    benefits: [
      {
        number: "01",
        title: "Inbound Interest",
        description: "Clients, investors, and job offers start landing in your DMs, on their own.",
      },
      {
        number: "02",
        title: "The Obvious Choice",
        description: "Consistent, sharp content builds recall, so people think of you first.",
      },
      {
        number: "03",
        title: "Trust Before the Meeting",
        description: "They already know your thinking. Half the convincing happens before you speak.",
      },
      {
        number: "04",
        title: "A Network That Compounds",
        description: "Every post reaches new people, building a following that keeps opening doors.",
      },
      {
        number: "05",
        title: "Room to Be Selective",
        description: "More inbound means you choose who you work with, on your terms.",
      },
      {
        number: "06",
        title: "A Lasting Reputation",
        description: "This stays, unlike an ad campaign. Your name becomes the asset.",
      },
    ],
  },
