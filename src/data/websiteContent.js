...
Resonance first. Reach follows.`,
  ...
  brandLogosRow: {
    heading: "Selected Brand Collaborations and Partnerships",
    brands: [
      { name: "Adidas", logo: "/logos/adidas.svg" },
      { name: "Amazon", logo: "/logos/amazon.svg" },
      { name: "Warner Bros", logo: "/logos/warnerbros.svg" },
      { name: "Sony TV", logo: "/logos/sonytv.svg" },
      { name: "Zee5", logo: "/logos/zee5.svg" },
      { name: "Jindal Steel", logo: "/logos/jindalsteel.svg" },
      { name: "Cars24", logo: "/logos/cars24.svg" },
      { name: "Denver", logo: "/logos/denver.png" },
      { name: "Acko", logo: "/logos/acko.svg" },
      { name: "One8", logo: "/logos/one8.svg" },
      { name: "Magicpin", logo: "/logos/magicpin.svg" },
      ...
      { name: "Urban Company", logo: "/logos/urbancompany.png" },
      { name: "Stable Money", logo: "/logos/stablemoney.svg" },
      { name: "IND Money", logo: "/logos/indmoney.png" },
      { name: "Shaadi.com", logo: "/logos/shaadi.svg" },
      { name: "Asian Paints", logo: "/logos/asianpaints.svg" },
    ],
  },
  ...
  about: {
    eyebrow: "ABOUT THE STUDIO AND THE BRAIN BEHIND IT.",
    ...
    paragraphs: [
      ...
      "Mostly, I write about how professionals can sound like themselves online while staying credible in the boardroom.",
      "That risk-and-compliance experience at Deloitte and KPMG still runs in the background. It's why I can write for a fintech founder one morning, AI and tech CXO in the afternoon and a infrastructure firm owner at night, each sounding entirely their own.",
      "Brand collaborations include Adidas, Warner Bros, Amazon, Asian Paints, Myntra, Zomato, One8, and 300+ others reaching founders, CXOs, and senior decision-makers on LinkedIn.",
    ...
    proofStats: [
      ...
      { label: "Corporate Alum", value: "Deloitte & KPMG" },
    ],
  ...
  services: {
    ...
    addons: [
      ...
      },
      {
        ...
        description: "Strategy, writing, and updates for your company's LinkedIn presence",
      },
    ],
  ...
  pricing: {
    ...
    addonsNote:
      "Available as add-ons: targeted outreach on LinkedIn, lead generation via Sales Navigator, content for the company page, and content or full account management on X (formerly Twitter).",
